...
outdir <- "C:/Users/49152/Downloads/Multi-omics/MOFA/output/graphs/Single_cell/GSEA/"
...
# =========================================================
# IMPORTANT: NORMALIZE FEATURE NAMES ONCE ONLY
# =========================================================
for(v in views){
...
for(view in views){
  ...
  for(sign in signs){
    ...
    # -----------------------------------
    # Filter factors that actually have usable weights
    # -----------------------------------
    ...
    # -----------------------------------
    # Run enrichment for ALL valid factors at once
    # -----------------------------------
    enrichment <- tryCatch({
      run_enrichment(
        model,
    ...
    # -----------------------------------
    # ONE HEATMAP PER VIEW × SIGN
    # -----------------------------------
    heat_file <- file.path(outdir,
                           paste0(view,"_",sign,"_enrichment_heatmap.png"))
...
#Mapping specific genes of interest onto factor 1/2 UMAP
